/// Copy for BLE connectivity errors and status messages.
abstract final class BleStrings {
  static const bluetoothUnavailable = 'Bluetooth is unavailable. Turn it on in system settings.';
